/* scheme.h for Chez Scheme Version 9.5.3.25 (ta6osx) */
...
#define Sinputportp(x) ((((uptr)(x)&0x7)==0x7) &&\
    (((uptr)((*((ptr *)((uptr)(x)+1))))&0x1FF)==0x1CE))
#define Soutputportp(x) ((((uptr)(x)&0x7)==0x7) &&\
    (((uptr)((*((ptr *)((uptr)(x)+1))))&0x2FF)==0x2CE))
...
#define Sstencil_vector_length(x) Spopcount(((uptr)(*((iptr *)((uptr)(x)+1))))>>6)
#define Sstencil_vector_ref(x,i) (((ptr *)((uptr)(x)+9))[i])
